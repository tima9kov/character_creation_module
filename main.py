...
def attack(char_name: str, char_class: str) -> str:
    """
    Функция генерирует количество очков атаки в зависимости от выбранного
...
def defence(char_name: str, char_class: str) -> str:
    """
    Функция генерирует количество очков защиты в зависимости от выбранного
    типа персонажа и возвращает строковое сообщение о выполненном блокировании
    атаки.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """
    В зависимости от выбранного типа персонажа возвращает сообщение
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Функция запускает цикл тренировки навыков персонажа. В качестве
    ...
    print('отренируйся управлять своими навыками.')
    print(
...
def choice_char_class() -> str:
    """
    Функция позволяет игроку выбрать тип игрового персонажа и
